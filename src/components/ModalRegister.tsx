		...
		<>
			...
			>
				<DialogTitle className="flex justify-between">
					Registro
					<IconButton aria-label="Cerrar ventana" onClick={handleClose}>
						<CloseIcon />
					</IconButton>
				</DialogTitle>
				<DialogContent>
					<div className="mt-2 flex flex-col gap-4">
						<TextField
							...
							label="RUT"
							type="text"
							helperText={RegisterForm.error.rut && "RUT Invalido"}
						...
						<TextField
							...
							type="text"
							helperText={RegisterForm.error.name && "Ingresa un valor"}
						...
						<TextField
							...
							label="Email"
							type="email"
							helperText={RegisterForm.error.email && "Email invalido"}
						...
						<TextField
							...
							type="password"
							helperText={
								RegisterForm.error.password && "Minimo de 5 caracteres"
							}
